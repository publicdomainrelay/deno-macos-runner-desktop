...
:root{
  ...
  --green:#a6e3a1;--yellow:#f9e2af;--divider:rgba(255,255,255,.06);--gear-bg:rgba(255,255,255,.06);
...
.log-level.info{background:rgba(137,180,250,.12);color:var(--accent)}
.log-level.warn{background:rgba(249,226,175,.12);color:var(--yellow)}
.log-level.error{background:rgba(243,139,168,.12);color:var(--danger-text)}
