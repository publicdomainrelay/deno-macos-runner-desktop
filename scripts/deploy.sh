...
SSH_TARGET="${SSH_TARGET:-root@tray.fedfork.com}"
...
# Deploy static files.
mkdir -p /var/www/tray.fedfork.com
rm -rf /var/www/tray.fedfork.com/*
mv /tmp/stage/oauth-client-metadata.json /var/www/tray.fedfork.com/
chown -R caddy:caddy /var/www/tray.fedfork.com
...
echo "Deploy complete -> https://tray.fedfork.com"
REMOTE_EOF
